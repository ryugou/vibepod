...
- JDK version: 25 (LTS, released 2025-09) baseline; newer JDK versions are acceptable. Earlier versions are out of scope. Use modern Java idioms (records, pattern matching for switch, sealed classes, `var` inference, text blocks, switch expressions, virtual threads, `Optional`, scoped values).
